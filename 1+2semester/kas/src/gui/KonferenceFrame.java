...
public class KonferenceFrame extends JFrame{
	...
	public KonferenceFrame() {
		...
		this.add(lblPris);
		lblPris.setLocation(20, 225);
		lblPris.setSize(100, 20);
	...
	private class Controller implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if (e.getSource() == btnOpret){
				Service.opretKonferrence(txfNavn.getText(), txfAdresse.getText(), Double.parseDouble(txfDato1.getText()), Double.parseDouble(txfDato2.getText()), Double.parseDouble(txfPris.getText()));
				
				KonferenceFrame.this.setVisible(false);
			}
}
}
}