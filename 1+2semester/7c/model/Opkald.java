...
public class Opkald {
	...
	public String toString(){
		String s = "";
		if (Service.findKontakt(nummer) != null)
			s = Service.findKontakt(nummer).getFornavn();
		else
			s = nummer+"";
		return s +": "+ (incommingCall ? "Indgående" : "Udgående") + (callAccpeted ? ". tid: " + getFormattedCallTime() : ". Opkald afvist");
	}
